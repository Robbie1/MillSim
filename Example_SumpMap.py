...
# Initial state
M_state = 1*Gen_PopBal.create_fracdist(Sump_Model.hinde_mesh(), 0.25, 10)[0]
...
F_in = (80.0 + np.random.rand(len(t_sim))*0.0)[:,None]*Gen_PopBal.create_fracdist(Sump_Model.hinde_mesh(), beta, d63)
